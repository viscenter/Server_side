   ...
   */
    ...
    if (options['citeROI']){ 
	    ...
	    if( options['citeROI'].split(",").length == 4 ){
			...
			alert("The requested region-of-interest was not formed correctly.");
			this.citeROI = null;
		}
  ...
  positionZone: function(){
	...
	highlightROI: function(){
			...
			ROIZone.addEvent( 'click',function(tempURL){ 
				...
				tempURL += iip.citeROI.left + "," + iip.citeROI.top + "," + iip.citeROI.width + "," + iip.citeROI.height + "&w=5000";				open(tempURL);
