  ...
  positionZone: function(){
	...
	highlightROI: function(){
			...
			ROIZone.addEvent( 'click',function(tempURL){ 
				...
				// http://amphoreus.hpcc.uh.edu/tomcat/chsimg/Img?request=GetBinaryImage&id=U4013VN-0026:0.25,0.31,0.18,0.019&w=5000
				//var tempURL = "http://amphoreus.hpcc.uh.edu/tomcat/chsimg/Img?request=GetBinaryImage&id=" + iip.imgID + ":" 
				//tempURL += iip.citeROI.left + "," + iip.citeROI.top + "," + iip.citeROI.width + "," + iip.citeROI.height + "&w=5000";
				//open(tempURL);
				var tempURL = "http://amphoreus.hpcc.uh.edu/tomcat/chsimg/Img?request=GetBinaryImage&urn=" + iip.imgURN;
				tempURL += "&w=8000";				
				open(tempURL);
